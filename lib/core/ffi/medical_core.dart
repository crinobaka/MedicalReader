...
typedef _MedicalCoreGetOutlineNative =
    Pointer<Utf8> Function(Pointer<_MedicalCoreDocument>);
typedef _MedicalCoreGetOutlineDart =
    Pointer<Utf8> Function(Pointer<_MedicalCoreDocument>);
...
class MedicalCore {
  MedicalCore._(this._library) {
    ...
    _getOutline = _library
        .lookup<NativeFunction<_MedicalCoreGetOutlineNative>>(
          'medical_core_get_outline',
        )
        .asFunction<_MedicalCoreGetOutlineDart>();
  ...
  String getOutline(Pointer<_MedicalCoreDocument> handle) {
    ...
    if (resultPointer == nullptr) {
      throw StateError('Failed to read PDF outline.');
    }
