...
class DocumentCard extends StatelessWidget {
  ...
  const DocumentCard({
    ...
    this.onTap,
    this.onDelete,
    this.layout = DocumentCardLayout.list,
  });
  ...
  Widget _buildCompact(BuildContext context) {
    return Card(
      ...
      child: ListTile(
        ...
        trailing: _Menu(onDelete: onDelete),
      ),
    );
  }
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(_metaText(), maxLines: 1, overflow: TextOverflow.ellipsis),
            ),
          ],
        ),
      ),
...
class _Menu extends StatelessWidget {
  ...
  const _Menu({required this.onDelete});
