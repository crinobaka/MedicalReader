...
class _EpubReaderPageState extends ConsumerState<EpubReaderPage> {
  ...
  int get _currentNavigationIndex {
    final items = _navigation;
    for (var i = 0; i < items.length; i++) {
      if (_controller.chapterIndexForHref(items[i].href) == _controller.chapterIndex) return i;
    }
    return -1;
  }
