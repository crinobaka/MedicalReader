...
class _EpubReaderPageState extends ConsumerState<EpubReaderPage> {
  ...
  Future<void> _saveHighlight(ReaderLookupContext lookup) async { 
    final href = lookup.href ?? _controller.archive?.chapterAt(_controller.chapterIndex)?.href; 
    ...
    await notifier.add(
      ReaderAnnotation(
        id: id, bookId: widget.document.id, 
        pageIndex: _controller.chapterIndex, 
        type: ReaderAnnotationType.highlight, 
        content: lookup.selectedText, 
        title: _chapterTitle(_controller.chapterIndex), 
        locator: EpubReaderLocator(href: href, startOffset: lookup.startOffset, endOffset: lookup.endOffset, textQuote: lookup.textQuote ?? lookup.selectedText, prefix: lookup.prefix, suffix: lookup.suffix), 
